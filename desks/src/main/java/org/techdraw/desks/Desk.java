...
import org.techdraw.sheets.elements.builders.LengthAnnotationBuilder;
...
public class Desk {
    ...
    public BoxedElement createElement() {
        ...
        group.addChild(new LineElement(0,0,aScaled,0, edges[0] ? fillStroke : noFillStroke ));
        group.addChild(new LineElement(aScaled,0,aScaled,bScaled, edges[1] ? fillStroke : noFillStroke ));
        group.addChild(new LineElement(0,bScaled,aScaled,bScaled, edges[2] ? fillStroke : noFillStroke ));
        group.addChild(new LineElement(0,0,0,bScaled, edges[3] ? fillStroke : noFillStroke ));
        group.addChild(new LengthAnnotationBuilder(0,bScaled,aScaled,bScaled,String.format("%.1f mm",a)).build());
        group.addChild(new LengthAnnotationBuilder(aScaled,bScaled,aScaled,0,String.format("%.1f mm",b)).build());
